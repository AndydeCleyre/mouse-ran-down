...
appdir=/app
image=${1:-ghcr.io/andykluger/mouse-ran-down}
...
RUN uv pip install --python "${appdir}/.venv/bin/python" --constraints "${appdir}/mouse_ran_down/requirements.txt" "${appdir}[sentry]"
